...
class IndeedScraperPipeline:
    ...
    async def run_scraping_phase(self, query: str, location: str = None, max_pages: int = None, date_filter: str = "1") -> List[JobListing]:
        ...
        logger.info("📊 Phase 1: Starting job scraping from Indeed...")
        ...
        try:
            ...
            logger.info(f"✅ Scraping completed: {len(scraped_jobs)} jobs found")
    ...
    async def run_storage_phase(self, jobs: List[JobListing]) -> int:
        ...
        logger.info("💾 Phase 2: Storing raw jobs in database...")
        ...
        try:
            ...
            logger.info(f"✅ Storage completed: {stored_count} new jobs stored, {duplicate_count} duplicates skipped")
    ...
    async def run_processing_phase(self, limit: int = None) -> int:
        ...
        logger.info("🔄 Phase 3: Processing jobs and matching companies...")
        ...
        try:
            ...
            if not unprocessed_jobs:
                logger.info("ℹ️ No unprocessed jobs found")
                return 0
